...
set CLASSPATH=%APP_HOME%\lib\logisim-evolution-3.8.0-all.jar

@rem Execute logisim-evolution
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LOGISIM_EVOLUTION_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%LOGISIM_EVOLUTION_EXIT_CONSOLE%" exit 1
exit /b 1
